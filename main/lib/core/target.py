        ...
        for place in (PLACE.GET, PLACE.POST, PLACE.COOKIE):
            ...
            for parameter in conf.paramDict.get(place, {}):
                if any(parameter.lower().count(_) for _ in CSRF_TOKEN_PARAMETER_INFIXES):
                    ...
                    message += "Do you want ramusql to automatically update it in further requests? [y/N] "
...
def _resumeDBMS():
    ...
    if conf.dbms:
        ...
        if not check:
            ...
            message += "ramusql assumes the back-end DBMS is '%s'. " % dbms
...
def _resumeOS():
    ...
    if os and os != 'None':
        ...
        if conf.os and conf.os.lower() != os.lower():
            ...
            message += "target URL ramusql assumes the back-end DBMS "
