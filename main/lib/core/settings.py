...
VERSION = "1.0"
TYPE = "dev" if VERSION.count('.') > 2 and VERSION.split('.')[-1] != '0' else "beta"
TYPE_COLORS = {"dev": 33, "stable": 90, "pip": 34}
VERSION_STRING = "ramusql/%s#%s" % ('.'.join(VERSION.split('.')[:-1]) if VERSION.count('.') > 2 and VERSION.split('.')[-1] == '0' else VERSION, TYPE)
DESCRIPTION = "automatic SQL injection and database takeover tool"
SITE = ""
DEFAULT_USER_AGENT = "%s (%s)" % (VERSION_STRING, SITE)
DEV_EMAIL_ADDRESS = "unset"
ISSUES_PAGE = "unset"
GIT_REPOSITORY = "unset"
GIT_PAGE = "unset"
WIKI_PAGE = "unset"
ZIPBALL_PAGE = "unset"
...
LEGAL_DISCLAIMER = "Use this program for attacking without permission is illegal.\nDeveloper not responsible for any misuse or damage caused by this program"
