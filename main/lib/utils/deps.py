...
def checkDependencies():
    ...
    for dbmsName, data in DBMS_DICT.items():
        ...
        try:
            ...
            warnMsg = "ramusql requires '%s' third-party library " % data[1]
    ...
    try:
        ...
        warnMsg = "ramusql requires 'python-impacket' third-party library for "
    ...
    try:
        ...
        warnMsg = "ramusql requires 'python-ntlm' third-party library "
    ...
    try:
        ...
        warnMsg = "ramusql requires 'websocket-client' third-party library "
    ...
    try:
        ...
        warnMsg = "ramusql requires 'tkinter' library "
    ...
    try:
        ...
        warnMsg = "ramusql requires 'tkinter.ttk' library "
        warnMsg += "if you plan to run a GUI"
        logger.warn(warnMsg)
    ...
    if IS_WIN:
        try:
            ...
            warnMsg = "ramusql requires 'pyreadline' third-party library to "
            warnMsg += "be able to take advantage of the ramusql TAB "
